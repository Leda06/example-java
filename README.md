...
[![Deploy to Koyeb](https://www.koyeb.com/static/images/deploy/button.svg)](https://app.koyeb.com/deploy?name=example-java&type=git&repository=koyeb/example-java&branch=main&run_command=.%2Fmvnw+exec%3Ajava)
...
5. If building from a buildpack, open the "Build and deployment settings" and set the "Run command" to `./mvnw exec:java`.
